...
#include "defs.h"
Lost::Lost(const MainWindow& _win,const int _score,const int _vol,const int _volt,const int _point)
    :win(_win),
    score(_score),
    vol(_vol),
    volt(_volt),
